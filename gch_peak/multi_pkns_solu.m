function [ Uexc,P,Q ] = multi_pkns_solu( P0,Q0,Nelm,elm_size, x ,period,Time,peak_type )
...
xi=zeros(peak_type,peak_type);
A=zeros(peak_type,peak_type);
B=zeros(peak_type,peak_type);
